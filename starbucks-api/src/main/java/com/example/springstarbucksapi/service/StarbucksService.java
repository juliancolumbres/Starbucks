...
public class StarbucksService {
    ...
    public StarbucksOrder newOrder(String regid, StarbucksOrder order) throws ResponseStatusException {
        ...
        StarbucksOrder active = ordersRepository.findByRegister(regid);
        if (active != null) {
    ...
    public StarbucksOrder getActiveOrder(String regid) {
        return ordersRepository.findByRegister(regid);
    }

     /* Get Details of a Starbucks Drink */
    public StarbucksDrink getDrink(Long orderId) {
    ...
    public void clearActiveOrder(String regid) {
        ...
        ordersRepository.deleteById(active.getId());
    }
    ...
    public StarbucksCard processOrder(String regid, String cardnum) throws ResponseStatusException {
        ...
        // queue processing
        rabbit.convertAndSend(queue.getName(), active.getId());
        StarbucksDrink drink = new StarbucksDrink();
        drink.setOrderId(active.getId());
        drink.setStatus("Processing");
